...
public class LimitedAura
    ...
    public void onTicks() {
        try {
            Wrapper.INSTANCE.world().loadedEntityList.stream().filter((o) -> (isWithinRange(4, (Entity) o))).filter((o) -> (((Entity) o).getEntityId() != Wrapper.INSTANCE.player().getEntityId())).forEachOrdered((o) -> {
