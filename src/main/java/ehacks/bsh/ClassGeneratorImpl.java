...
extends ClassGenerator {
    ...
    public static Class generateClassImpl(String string, Modifiers modifiers, Class[] arrclass, Class class_, BSHBlock bSHBlock, boolean bl, CallStack callStack, Interpreter interpreter) throws EvalError {
        try {
            ...
            throw new EvalError("Defining classes currently requires reflective Accessibility.", (SimpleNode)bSHBlock, callStack);
        }
        ...
        bSHBlock.evalBlock(callStack, interpreter, true, (BSHBlock.NodeFilter)ClassNodeFilter.CLASSCLASSES);
        ...
        if (string5 != null) {
            try {
                FileOutputStream object = new FileOutputStream(string5 + "/" + string3 + ".class");
                object.write(arrby);
                object.close();
            }
        ...
        try {
            nameSpace2.setLocalVariable("_bshInstanceInitializer", (Object)bSHBlock, false);
        }
        catch (UtilEvalError utilEvalError) {
            throw new InterpreterError("unable to init static: " + (Object)utilEvalError);
        }
        nameSpace2.setClassStatic((Class)object1);
        bSHBlock.evalBlock(callStack, interpreter, true, (BSHBlock.NodeFilter)ClassNodeFilter.CLASSSTATIC);
        callStack.pop();
        if (!object1.isInterface()) {
            String string6 = "_bshStatic" + string3;
            try {
                LHS lHS = Reflect.getLHSStaticField((Class)object1, (String)string6);
                lHS.assign((Object)nameSpace2.getThis(interpreter), false);
            }
        ...
        while (n < bSHBlock.jjtGetNumChildren()) {
            ...
            if (simpleNode instanceof BSHTypedVariableDeclaration) {
                ...
                while (n2 < arrbSHVariableDeclarator.length) {
                    ...
                    try {
                        Variable variable = new Variable(string3, string2, (Object)null, modifiers);
    ...
    public static Object invokeSuperclassMethodImpl(BSHClassManager bshClassManager, Object object, String string, Object[] arrobject) throws UtilEvalError, ReflectError, InvocationTargetException {
        ...
        Method method = Reflect.resolveJavaMethod((BSHClassManager)bshClassManager, class_, (String)string2, (Class[])Types.getTypes((Object[])arrobject), (boolean)false);
        if (method != null) {
            return Reflect.invokeMethod((Method)method, (Object)object, (Object[])arrobject);
        }
        Class class_2 = class_.getSuperclass();
        method = Reflect.resolveExpectedJavaMethod((BSHClassManager)bshClassManager, class_2, (Object)object, (String)string, (Object[])arrobject, (boolean)false);
        return Reflect.invokeMethod((Method)method, (Object)object, (Object[])arrobject);
    }
