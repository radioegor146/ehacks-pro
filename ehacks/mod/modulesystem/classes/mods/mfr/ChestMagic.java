package ehacks.mod.modulesystem.classes.mods.mfr;

import ehacks.mod.api.ModStatus;
import ehacks.mod.api.Module;
import ehacks.mod.modulesystem.classes.keybinds.GiveKeybind;
import ehacks.mod.modulesystem.classes.keybinds.SelectPlayerKeybind;
...
public class ChestMagic
    ...
    public void onTicks() {
        ...
        prevState = newState;
        boolean newStateT = Keyboard.isKeyDown(SelectPlayerKeybind.getKey());
