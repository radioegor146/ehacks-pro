package ehacks.mod.modulesystem.classes.mods.nuclearcontrol;
...
public class IC2SignEdit
    ...
    public String getDescription() {
        return "Allows you to edit configs of blocks from the IC2 Nuclear Control mod with right click";
    }
    ...
    public void onMouse(MouseEvent event) {
        try {
            ...
            if (entity != null && Class.forName("shedar.mods.ic2.nuclearcontrol.tileentities.TileEntityInfoPanel").isInstance(entity) && Mouse.isButtonDown(1)) {
                ...
                fakeGuiOpened = true;
                Wrapper.INSTANCE.mc().displayGuiScreen(guiInfoPanel);
