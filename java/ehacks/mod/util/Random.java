...
public class Random {
	...
	private TileEntity[] tiles = { new TileEntityPiston(), new TileEntityNote(), new TileEntityMobSpawner(), new TileEntityCommandBlock(), new TileEntityBeacon() };
        private Entity[] entityes = { new EntityBlaze(null), new EntityCreeper(null), new EntityGhast(null), new EntitySlime(null), new EntitySpider(null) }; 
	private int randCoordCorr;
