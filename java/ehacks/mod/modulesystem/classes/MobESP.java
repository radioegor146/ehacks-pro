...
public class MobESP
    ...
    public void onWorldRender(RenderWorldLastEvent event) {
        ...
        for (Object o : Wrapper.INSTANCE.world().loadedEntityList) {
            ...
            GLUtils.drawRect(-25f, 6f, -25f + (50f * Math.min(ent.getHealth(), ent.getMaxHealth()) / ent.getMaxHealth()), 11f, GLUtils.getColor(255, 0, 255, 0));
            GLUtils.drawRect(-25f + (50f * Math.min(ent.getHealth(), ent.getMaxHealth()) / ent.getMaxHealth()), 6f, 25f, 11f, GLUtils.getColor(255, 255, 0, 0));
