...
public class ConsoleGui extends Gui
{
    ...
    public void drawChat(int tickid)
    {
        ...
        int j = this.getShownMessagesCount();
        boolean flag = false;
        int k = 0;
        ...
        if (l > 0)
        {
            ...
            GL11.glTranslatef(get.getScaledWidth() - 6 - func_146228_f(), get.getScaledHeight() - 28, 0.0F);
    ...
    private void func_146237_a(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_)
    {
        ...
        int k = MathHelper.floor_float((float)this.func_146228_f() / this.getChatScale());
        int l = 0;
    ...
    public void scroll(int p_146229_1_)
    {
        ...
        if (this.field_146250_j > j - this.getShownMessagesCount())
        {
            this.field_146250_j = j - this.getShownMessagesCount();
        }
    ...
    public IChatComponent func_146236_a(int p_146236_1_, int p_146236_2_)
    {
        ...
        else
        {
            ...
            if (l >= 0 && i1 >= 0)
            {
                int j1 = Math.min(this.getShownMessagesCount(), this.field_146253_i.size());

                if (l <= MathHelper.floor_float((float)this.func_146228_f() / this.getChatScale()) && i1 < this.mc.fontRenderer.FONT_HEIGHT * j1 + j1)
                {
    ...
    public int getShownMessagesSize()
    {
    ...
    public int getShownMessagesCount()
    {
        return this.getShownMessagesSize() / 9;
    }
}