...
public class SimpleButton {
    ...
    public void draw() {
        GLUtils.drawGradientBorderedRect((double) this.getX(), (double) this.getY(), (double) this.getX() + sizeX, this.getY() + sizeY, 0.5f, -12303292, !pressed ? -8947849 : -11184811, !pressed ? -11184811 : -10066330);
        Wrapper.INSTANCE.fontRenderer().drawStringWithShadow(this.title, this.getX() + sizeX / 2 - Wrapper.INSTANCE.fontRenderer().getStringWidth(this.title) / 2, this.getY() + (this.sizeY / 2 - Wrapper.INSTANCE.fontRenderer().FONT_HEIGHT / 2), pressed ? 5636095 : color);
    }
