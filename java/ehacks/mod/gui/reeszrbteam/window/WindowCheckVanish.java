...
import static ehacks.mod.gui.reeszrbteam.window.WindowPlayerIds.useIt;
...
extends YAWWindow {        
    ...
    public void draw(int x, int y) {
        ...
        if (this.isOpen()) {
            ...
            GLUtils.drawGradientBorderedRect(this.getX() + this.dragX, this.getY() + this.dragY, this.getX() + 90 + 100 + this.dragX, this.getY() + 12 + this.dragY, 0.5f, -16777216, -6710887, -8947849);
            ...
            GLUtils.drawGradientBorderedRect(this.getX() + 70 + 100 + this.dragX, this.getY() + 2 + this.dragY, this.getX() + 78 + 100 + this.dragX, this.getY() + 10 + this.dragY, 1.0f, -10066330, this.isPinned() ? -8947849 : -7829368, this.isPinned() ? -11184811 : -10066330);
            GLUtils.drawGradientBorderedRect(this.getX() + this.dragX, this.getY() + 14 + this.dragY, this.getX() + 90 + 100 + this.dragX, this.getY() + 14 + this.dragY + 4 * 12, 0.5f, -16777216, -6710887, -8947849);
